function generate() {
  ...
  const hexArray = SHA256(verifier)
    .replace(/\r|\n/g, "")
...
function openurl() {
  const challenge = document.getElementById("codechallenge").value;
  const verifier = document.getElementById("codeverifier").value;

  let url = "https:///a7krux4ab.accounts.ondemand.com/oauth2/authorize";
  url += "?client_id=4729bdc7-22ca-4f4b-9e85-fdf20416a99f";
 ...
 *  See buildApps/LICENSE for license details!
 *
 **/
